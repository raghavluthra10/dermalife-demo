    ...
    <section className="py-spacing-section px-6 bg-white">
      <div className="max-w-7xl mx-auto">
        <div className="flex items-end justify-between mb-12">
          <h2 className="text-4xl md:text-5xl  font-primary font-bold uppercase tracking-tighter">The DermaLife Buzz</h2>
          <a href="#" className="text-brand-gold font-bold uppercase tracking-widest text-sm border-b-2 border-brand-gold pb-1 hover: transition-colors font-primary">
            View All
          </a>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {blogs.map((blog, i) => (
             <div key={i} className="group cursor-pointer">
                ...
                <h3 className="text-xl font-primary  group-hover: transition-colors line-clamp-2 font-bold leading-snug uppercase tracking-tight">
                  {blog.title}
                </h3>
             </div>
          ))}
