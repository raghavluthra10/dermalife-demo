       ...
       <div className="max-w-7xl mx-auto relative h-[450px] rounded-[4rem] overflow-hidden group cursor-pointer shadow-2xl">
          ...
          <div className="relative z-20 h-full flex flex-col items-center justify-center text-center px-6">
             ...
             <button 
                ...
                className="inline-flex items-center gap-4 px-12 py-6 bg-white  font-extrabold rounded-full hover:bg-brand-gold hover:text-white transition-all shadow-xl group/link uppercase tracking-[0.2em] text-xs font-primary"
             >
