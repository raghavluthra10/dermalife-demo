    ...
    <div className="bg-brand-cream min-h-screen pt-[104px]">
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        <nav className="text-[10px] md:text-xs uppercase tracking-[0.2em] font-bold text-brand-dark/40">
          ...
          <span className="mx-2 text-brand-gold">›</span>
          <span className="text-brand-dark uppercase tracking-widest">Botox</span>
        </nav>
      </div>
      ...
      <section className="max-w-7xl mx-auto px-6 pb-24">
        <div className="flex flex-col lg:flex-row gap-16 items-center">
          <div className="w-full lg:w-1/2">
            ...
            >
              Botox — look refreshed, <br /> <span className="text-brand-gold italic font-normal text-5xl md:text-[56px]">not different</span>
            </motion.h1>
            <motion.p
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              Botox relaxes the muscles responsible for expression lines — smoothing forehead lines, frown lines, crow's feet, and more. When administered correctly by a certified dermatologist, Botox produces a refreshed, well-rested appearance that looks completely natural — never frozen, never obvious.
            </motion.p>
          ...
          <div className="w-full lg:w-1/2">
            <div className="aspect-[4/5] bg-[#E5E1DA] rounded-[24px] overflow-hidden relative border border-brand-muted/30 group">
              ...
              <div className="absolute inset-0 flex items-center justify-center text-brand-dark/10 uppercase tracking-widest text-[10px] font-bold">Botox Image Placeholder</div>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="flex flex-col lg:flex-row gap-16">
            <div className="w-full lg:w-1/2 text-white">
              ...
              <h2 className="text-3xl md:text-5xl font-primary font-bold uppercase tracking-tighter leading-tight mb-8 text-white">
                The difference is always <br /> in who administers it.
              </h2>
              <p className="font-sans text-[16px] md:text-[18px] text-white/60 leading-[1.7] mb-8">
                Botox results are entirely dependent on the skill, knowledge, and precision of the person administering it. Too much in the wrong place produces the frozen, unnatural look everyone fears. At Dermalife, every Botox treatment is performed exclusively by our certified dermatologists who understand facial muscle anatomy at a clinical level — placing exactly the right amount, in exactly the right muscles.
              </p>
            ...
            <div className="w-full lg:w-1/2 flex items-center">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-6 w-full">
                {[
                  { text: "Forehead and frown lines smoothed", icon: <Target className="text-brand-gold" size={20} /> },
                  { text: "Crow's feet and smile lines relaxed", icon: <Activity className="text-brand-gold" size={20} /> },
                  { text: "Natural, refreshed result — not frozen", icon: <ShieldCheck className="text-brand-gold" size={20} /> },
                  { text: "Quick treatment, zero downtime", icon: <Zap className="text-brand-gold" size={20} /> }
                ].map((item, i) => (
      ...
      <section className="py-24 bg-brand-cream relative overflow-hidden text-center border-t border-brand-muted/30" id="booking-section">
        ...
        <div className="max-w-4xl mx-auto px-6 relative z-10">
          <h2 className="text-3xl md:text-[56px] font-primary font-bold text-brand-dark leading-[1.1] mb-6 uppercase tracking-tighter text-black">
            Want to look refreshed <br /> <span className="text-brand-gold italic font-normal text-4xl md:text-5xl lg:text-[52px]">without looking different?</span>
          </h2>
          <p className="font-sans text-base md:text-lg text-brand-dark/60 mb-12 max-w-2xl mx-auto leading-relaxed">
            Book a free consultation — our dermatologist will assess your face and recommend exactly the right Botox placement for a natural result.
          </p>
