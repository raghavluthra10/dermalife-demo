...
import { ArrowUpRight, Check, Phone, Target, Activity, Sparkles, Clock } from 'lucide-react';
    ...
    <div className="bg-brand-cream min-h-screen pt-[104px]">
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        <nav className="text-[10px] md:text-xs uppercase tracking-[0.2em] font-bold text-brand-dark/40">
          ...
          <span className="mx-2 text-brand-gold">›</span>
          <span className="text-brand-dark uppercase tracking-widest">Body Trim</span>
        </nav>
      </div>
      ...
      <section className="max-w-7xl mx-auto px-6 pb-24">
        <div className="flex flex-col lg:flex-row gap-16 items-center">
          <div className="w-full lg:w-1/2">
            ...
            >
              Body trim — targeted <br /> <span className="text-brand-gold italic font-normal text-5xl md:text-[56px]">fat reduction & reshaping</span>
            </motion.h1>
            <motion.p
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              Body Trim is a targeted body contouring treatment designed to reduce localised fat deposits in specific problem areas — belly, arms, thighs, back, and flanks. Using a combination of technologies, it reshapes and redefines the body without surgery, needles, or any recovery time.
            </motion.p>
          ...
          <div className="w-full lg:w-1/2">
            <div className="aspect-[4/5] bg-[#E5E1DA] rounded-[24px] overflow-hidden relative border border-brand-muted/30">
              <div className="absolute inset-0 flex items-center justify-center text-brand-dark/10 uppercase tracking-widest text-[10px] font-bold">Body Trim Image Placeholder</div>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="flex flex-col lg:flex-row gap-16">
            <div className="w-full lg:w-1/2 text-white">
              ...
              <h2 className="text-3xl md:text-5xl font-primary font-bold uppercase tracking-tighter leading-tight mb-8 text-white">
                Target exactly where <br /> you want to lose.
              </h2>
              <p className="font-sans text-[16px] md:text-[18px] text-white/60 leading-[1.7] mb-8">
                Generic weight loss treatments reduce fat overall — Body Trim allows us to target specific problem areas precisely. At Dermalife, every Body Trim treatment is assessed by our certified dermatologists who map your fat distribution and design a treatment protocol targeted at your specific concern areas.
              </p>
            ...
            <div className="w-full lg:w-1/2 flex items-center">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-6 w-full">
                {[
                  { text: "Localised fat in problem areas reduced", icon: <Target className="text-brand-gold" size={20} /> },
                  { text: "Body shape and contour redefined", icon: <Activity className="text-brand-gold" size={20} /> },
                  { text: "Suitable for belly, arms, thighs and back", icon: <Sparkles className="text-brand-gold" size={20} /> },
                  { text: "No surgery, no downtime", icon: <Clock className="text-brand-gold" size={20} /> }
                ].map((item, i) => (
      ...
      <section className="py-24 bg-brand-cream relative overflow-hidden text-center border-t border-brand-muted/30" id="booking-section">
        ...
        <div className="max-w-4xl mx-auto px-6 relative z-10">
          <h2 className="text-3xl md:text-[56px] font-primary font-bold text-brand-dark leading-[1.1] mb-6 uppercase tracking-tighter text-black">
            Ready to target your <br /> <span className="text-brand-gold italic font-normal text-5xl md:text-[56px]">problem areas specifically?</span>
          </h2>
          <p className="font-sans text-base md:text-lg text-brand-dark/60 mb-12 max-w-2xl mx-auto">
            Book a free consultation — our dermatologist will map your fat distribution and design a targeted Body Trim protocol.
          </p>
