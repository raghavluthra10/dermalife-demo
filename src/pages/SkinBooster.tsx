...
import { ArrowUpRight, Check, Phone, Sparkles, HeartPulse, ShieldCheck, Zap } from 'lucide-react';
    ...
    <div className="bg-brand-cream min-h-screen pt-[104px]">
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        <nav className="text-[10px] md:text-xs uppercase tracking-[0.2em] font-bold text-brand-dark/40">
          ...
          <span className="mx-2 text-brand-gold">›</span>
          <span className="text-brand-dark uppercase tracking-widest">Skin Booster</span>
        </nav>
      </div>
      ...
      <section className="max-w-7xl mx-auto px-6 pb-24">
        <div className="flex flex-col lg:flex-row gap-16 items-center">
          <div className="w-full lg:w-1/2">
            ...
            >
              Skin booster — <br /> <span className="text-brand-gold italic font-normal text-5xl md:text-[56px]">deep hydration & lasting glow</span>
            </motion.h1>
            <motion.p
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              Skin boosters deliver hyaluronic acid directly into the skin through a series of micro-injections — deeply hydrating from within for lasting plumpness, elasticity, and a visible glow that no topical skincare product can replicate. The skin literally looks and feels more alive.
            </motion.p>
          ...
          <div className="w-full lg:w-1/2">
            <div className="aspect-[4/5] bg-[#E5E1DA] rounded-[24px] overflow-hidden relative border border-brand-muted/30 group">
              ...
              <div className="absolute inset-0 flex items-center justify-center text-brand-dark/10 uppercase tracking-widest text-[10px] font-bold">Skin Booster Image Placeholder</div>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="flex flex-col lg:flex-row gap-16">
            <div className="w-full lg:w-1/2 text-white">
              ...
              <h2 className="text-3xl md:text-5xl font-primary font-bold uppercase tracking-tighter leading-tight mb-8 text-white">
                Hydration that goes deeper <br /> than any cream ever could.
              </h2>
              <p className="font-sans text-[16px] md:text-[18px] text-white/60 leading-[1.7] mb-8">
                Skin booster injections must be placed at the correct depth and spacing throughout the face to achieve even, natural-looking hydration without lumps or unevenness. At Dermalife, every skin booster treatment is administered by our certified dermatologists using precise micro-injection technique for a perfectly smooth, glowing result.
              </p>
            ...
            <div className="w-full lg:w-1/2 flex items-center">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-6 w-full">
                {[
                  { text: "Deep skin hydration restored", icon: <Sparkles className="text-brand-gold" size={20} /> },
                  { text: "Skin plumpness and bounce improved", icon: <Zap className="text-brand-gold" size={20} /> },
                  { text: "Visible glow from within", icon: <HeartPulse className="text-brand-gold" size={20} /> },
                  { text: "Suitable for face, neck and hands", icon: <ShieldCheck className="text-brand-gold" size={20} /> }
                ].map((item, i) => (
      ...
      <section className="py-24 bg-brand-cream relative overflow-hidden text-center border-t border-brand-muted/30" id="booking-section">
        ...
        <div className="max-w-4xl mx-auto px-6 relative z-10">
          <h2 className="text-3xl md:text-[56px] font-primary font-bold text-brand-dark leading-[1.1] mb-6 uppercase tracking-tighter text-black">
            Want skin that glows <br /> <span className="text-brand-gold italic font-normal text-4xl md:text-5xl lg:text-[52px]">from the inside out?</span>
          </h2>
          <p className="font-sans text-base md:text-lg text-brand-dark/60 mb-12 max-w-2xl mx-auto leading-relaxed">
            Book a free consultation — our dermatologist will assess your skin hydration levels and recommend the right skin booster protocol for you.
          </p>
