        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-8">
            ...
            <p className="text-white/40 text-sm md:text-base max-w-sm mb-2">
              We invest in the world's most advanced, FDA-approved body contouring platforms to ensure safe and effective fat reduction.
            </p>
          </div>
          ...
          <div className="flex overflow-x-auto no-scrollbar snap-x snap-mandatory md:grid md:grid-cols-2 lg:grid-cols-4 gap-6 pb-4 md:pb-0">
            {[
              { name: "Ondacool Platform", type: "Cool Energy Fat Freezing", use: "Stubborn Fat & Tightening" },
              { name: "LipoLasere Pro", type: "Laser Fat Reduction", use: "Inch Loss & Sculpting" },
              { name: "M-Sculpt EMS", type: "Electromagnetic Stimulation", use: "Muscle Building & Fat Loss" },
              { name: "Metaslim Analyzer", type: "Body Composition", use: "Precise Diagnosis" },
            ].map((tech, i) => (
              <motion.div
                key={i}
