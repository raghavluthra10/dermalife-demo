...
import { ArrowUpRight, Check, Phone, Zap, Activity, Sparkles, Clock, Target } from 'lucide-react';
    ...
    <div className="bg-brand-cream min-h-screen pt-[104px]">
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        <nav className="text-[10px] md:text-xs uppercase tracking-[0.2em] font-bold text-brand-dark/40">
          ...
          <span className="mx-2 text-brand-gold">›</span>
          <span className="text-brand-dark uppercase tracking-widest">M-Sculpt</span>
        </nav>
      </div>
      ...
      <section className="max-w-7xl mx-auto px-6 pb-24">
        <div className="flex flex-col lg:flex-row gap-16 items-center">
          <div className="w-full lg:w-1/2">
            ...
            >
              M-sculpt — build muscle <br /> <span className="text-brand-gold italic font-normal text-5xl md:text-[56px]">and burn fat</span>
            </motion.h1>
            <motion.p
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              M-Sculpt uses High-Intensity Focused Electromagnetic (HIFEM) technology to induce powerful muscle contractions that are impossible to achieve through exercise alone. In a single session, it burns surrounding fat while simultaneously building and toning muscle — giving you the results of thousands of crunches or squats without moving a muscle.
            </motion.p>
          ...
          <div className="w-full lg:w-1/2">
            <div className="aspect-[4/5] bg-[#E5E1DA] rounded-[24px] overflow-hidden relative border border-brand-muted/30 group">
              ...
              <div className="absolute inset-0 flex items-center justify-center text-brand-dark/10 uppercase tracking-widest text-[10px] font-bold">M-Sculpt Image Placeholder</div>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="flex flex-col lg:flex-row gap-16">
            <div className="w-full lg:w-1/2 text-white">
              ...
              <h2 className="text-3xl md:text-5xl font-primary font-bold uppercase tracking-tighter leading-tight mb-8 text-white">
                The workout you never <br /> have to do.
              </h2>
              <p className="font-sans text-[16px] md:text-[18px] text-white/60 leading-[1.7] mb-8">
                M-Sculpt delivers supramaximal muscle contractions — contracting muscles at 100% intensity which is impossible voluntarily. At Dermalife, every M-Sculpt treatment is assessed by our certified dermatologists who determine the right intensity, duration, and target areas based on your body composition and goals.
              </p>
            ...
            <div className="w-full lg:w-1/2 flex items-center">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-6 w-full">
                {[
                  { text: "Muscle mass built without exercise", icon: <Zap className="text-brand-gold" size={20} /> },
                  { text: "Fat in treated area simultaneously burned", icon: <Activity className="text-brand-gold" size={20} /> },
                  { text: "Abdomen, arms, thighs and buttocks treated", icon: <Target className="text-brand-gold" size={20} /> },
                  { text: "No downtime, no sweat, no effort", icon: <Clock className="text-brand-gold" size={20} /> }
                ].map((item, i) => (
      ...
      <section className="py-24 bg-brand-cream relative overflow-hidden text-center border-t border-brand-muted/30" id="booking-section">
        ...
        <div className="max-w-4xl mx-auto px-6 relative z-10">
          <h2 className="text-3xl md:text-[56px] font-primary font-bold text-brand-dark leading-[1.1] mb-6 uppercase tracking-tighter text-black">
            Want to build muscle and <br /> <span className="text-brand-gold italic font-normal text-5xl md:text-[56px]">burn fat without the gym?</span>
          </h2>
          <p className="font-sans text-base md:text-lg text-brand-dark/60 mb-12 max-w-2xl mx-auto">
            Book a free consultation — our dermatologist will assess your body composition and design the right M-Sculpt protocol for you.
          </p>
