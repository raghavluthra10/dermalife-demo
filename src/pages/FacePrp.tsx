...
import { ArrowUpRight, Check, Phone, Target, Sparkles, ShieldCheck, Layers, HeartPulse } from 'lucide-react';
    ...
    <div className="bg-brand-cream min-h-screen pt-[104px]">
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        <nav className="text-[10px] md:text-xs uppercase tracking-[0.2em] font-bold text-brand-dark/40">
          ...
          <span className="mx-2 text-brand-gold">›</span>
          <span className="text-brand-dark uppercase tracking-widest">Face PRP</span>
        </nav>
      </div>
      ...
      <section className="max-w-7xl mx-auto px-6 pb-24">
        <div className="flex flex-col lg:flex-row gap-16 items-center">
          <div className="w-full lg:w-1/2">
            ...
            >
              Platelet-Rich Plasma therapy uses your own blood's healing power to rejuvenate and regenerate your skin. A small amount of your blood is processed to concentrate growth factors — which are then reintroduced into your skin to stimulate natural collagen production and cellular repair.
            </motion.p>
          ...
          <div className="w-full lg:w-1/2">
            <div className="aspect-[4/5] bg-[#E5E1DA] rounded-[24px] overflow-hidden relative border border-brand-muted/30">
              <div className="absolute inset-0 flex items-center justify-center text-brand-dark/10 uppercase tracking-widest text-[10px] font-bold">Face PRP Image Placeholder</div>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="flex flex-col lg:flex-row gap-16">
            <div className="w-full lg:w-1/2 text-white">
              ...
              <h2 className="text-3xl md:text-5xl font-primary font-bold uppercase tracking-tighter leading-tight mb-8 text-white">
                Your own body's power, <br /> working for your skin.
              </h2>
              <p className="font-sans text-[16px] md:text-[18px] text-white/60 leading-[1.7] mb-8">
                PRP is a medical procedure requiring sterile technique and clinical expertise. Every Face PRP treatment at Dermalife is performed by our certified dermatologists in a fully clinical environment — with proper blood handling, centrifuge calibration, and sterile administration protocols.
              </p>
            ...
            <div className="w-full lg:w-1/2 flex items-center">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-6 w-full">
                {[
                  ...
                  { text: "Collagen and elastin production boosted", icon: <Sparkles className="text-brand-gold" size={20} /> },
                  { text: "Fine lines and laxity visibly improved", icon: <Layers className="text-brand-gold" size={20} /> },
      ...
      <section className="py-24 bg-brand-cream relative overflow-hidden text-center border-t border-brand-muted/30">
        ...
        <div className="max-w-4xl mx-auto px-6 relative z-10">
          <h2 className="text-3xl md:text-[56px] font-primary font-bold text-brand-dark leading-[1.1] mb-6 uppercase tracking-tighter text-black">
            Want natural, long-lasting <br /> <span className="text-brand-gold italic font-normal">skin rejuvenation?</span>
          </h2>
          <p className="font-sans text-base md:text-lg text-brand-dark/60 mb-12 max-w-2xl mx-auto">
            Book a free consultation — our dermatologist will assess your skin and tell you if PRP is right for your concern.
          </p>
