    ...
    <div className="bg-brand-cream min-h-screen pt-[104px]">
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        <nav className="text-[10px] md:text-xs uppercase tracking-[0.2em] font-bold text-brand-dark/40">
          ...
          <span className="mx-2 text-brand-gold">›</span>
          <span className="text-brand-dark uppercase tracking-widest">Deep Repair Facial</span>
        </nav>
      </div>
      ...
      <section className="max-w-7xl mx-auto px-6 pb-24">
        <div className="flex flex-col lg:flex-row gap-16 items-center">
          <div className="w-full lg:w-1/2">
            ...
            >
              Deep repair facial — <br /> <span className="text-brand-gold italic font-normal text-5xl md:text-[56px]">intensive restoration</span>
            </motion.h1>
            <motion.p
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              An intensive skin repair treatment designed for skin that is damaged, stressed, compromised, or in need of serious restoration. Whether from sun damage, pollution, over-treatment, sensitivity, or barrier damage — the Deep Repair Facial works at multiple levels to rebuild, restore, and heal the skin from within.
            </motion.p>
          ...
          <div className="w-full lg:w-1/2">
            <div className="aspect-[4/5] bg-[#E5E1DA] rounded-[24px] overflow-hidden relative border border-brand-muted/30 group">
              ...
              <div className="absolute inset-0 flex items-center justify-center text-brand-dark/10 uppercase tracking-widest text-[10px] font-bold">Deep Repair Image Placeholder</div>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="flex flex-col lg:flex-row gap-16">
            <div className="w-full lg:w-1/2 text-white">
              ...
              <h2 className="text-3xl md:text-5xl font-primary font-bold uppercase tracking-tighter leading-tight mb-8 text-white">
                When your skin needs <br /> more than just a facial.
              </h2>
              <p className="font-sans text-[16px] md:text-[18px] text-white/60 leading-[1.7] mb-8">
                Damaged and compromised skin requires a very specific approach — the wrong treatment can worsen sensitivity, trigger reactions, and cause further damage. At Dermalife, our Deep Repair Facial is customised entirely around your skin's current state — using gentle, clinically proven repair actives and barrier-restoring techniques administered by our trained specialists.
              </p>
            ...
            <div className="w-full lg:w-1/2 flex items-center">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-6 w-full">
                {[
                  { text: "Damaged skin barrier rebuilt", icon: <ShieldCheck className="text-brand-gold" size={20} /> },
                  { text: "Inflammation and sensitivity calmed", icon: <Target className="text-brand-gold" size={20} /> },
                  { text: "Sun and pollution damage repaired", icon: <Activity className="text-brand-gold" size={20} /> },
                  { text: "Skin health and resilience restored", icon: <Zap className="text-brand-gold" size={20} /> }
                ].map((item, i) => (
      ...
      <section className="py-24 bg-brand-cream relative overflow-hidden text-center border-t border-brand-muted/30" id="booking-section">
        ...
        <div className="max-w-4xl mx-auto px-6 relative z-10">
          <h2 className="text-3xl md:text-[56px] font-primary font-bold text-brand-dark leading-[1.1] mb-6 uppercase tracking-tighter text-black">
            Is your skin in need <br /> <span className="text-brand-gold italic font-normal text-4xl md:text-5xl lg:text-[52px]">of serious repair?</span>
          </h2>
          <p className="font-sans text-base md:text-lg text-brand-dark/60 mb-12 max-w-2xl mx-auto leading-relaxed">
            Book a free consultation — our specialists will assess your skin's condition and design the right deep repair protocol to restore it.
          </p>
...
export default DeepRepairFacial;
