...
import { ArrowUpRight, Check, Phone, Target, Layers, Sparkles, ShieldCheck } from 'lucide-react';
    ...
    <div className="bg-brand-cream min-h-screen pt-[104px]">
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        <nav className="text-[10px] md:text-xs uppercase tracking-[0.2em] font-bold text-brand-dark/40">
          ...
          <span className="mx-2 text-brand-gold">›</span>
          <span className="text-brand-dark uppercase tracking-widest">Dermal Fillers</span>
        </nav>
      </div>
      ...
      <section className="max-w-7xl mx-auto px-6 pb-24">
        <div className="flex flex-col lg:flex-row gap-16 items-center">
          <div className="w-full lg:w-1/2">
            ...
            >
              Dermal fillers — <br /> <span className="text-brand-gold italic font-normal text-5xl md:text-[56px]">restore volume & define features</span>
            </motion.h1>
            <motion.p
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              Dermal fillers use hyaluronic acid — a substance naturally found in the skin — to restore lost volume, define facial features, and smooth deep lines. At Dermalife, every filler treatment is performed exclusively by our certified dermatologists for results that look completely natural, never overdone.
            </motion.p>
          ...
          <div className="w-full lg:w-1/2">
            <div className="aspect-[4/5] bg-[#E5E1DA] rounded-[24px] overflow-hidden relative border border-brand-muted/30 group">
              ...
              <div className="absolute inset-0 flex items-center justify-center text-brand-dark/10 uppercase tracking-widest text-[10px] font-bold">Fillers Image Placeholder</div>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="flex flex-col lg:flex-row gap-16">
            <div className="w-full lg:w-1/2 text-white">
              ...
              <h2 className="text-3xl md:text-5xl font-primary font-bold uppercase tracking-tighter leading-tight mb-8 text-white">
                Natural results. <br /> Medical precision.
              </h2>
              <p className="font-sans text-[16px] md:text-[18px] text-white/60 leading-[1.7] mb-8">
                Dermal fillers in the wrong hands produce unnatural, overfilled results that are immediately obvious. At Dermalife, every filler is placed with medical precision by our certified dermatologists who understand facial anatomy at a clinical level — ensuring the right amount, in the right place, for results that enhance without altering.
              </p>
            ...
            <div className="w-full lg:w-1/2 flex items-center">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-6 w-full">
                {[
                  { text: "Lost facial volume restored naturally", icon: <Layers className="text-brand-gold" size={20} /> },
                  { text: "Deep lines and folds smoothed", icon: <Sparkles className="text-brand-gold" size={20} /> },
                  { text: "Features defined and enhanced precisely", icon: <Target className="text-brand-gold" size={20} /> },
                  { text: "100% reversible — complete peace of mind", icon: <ShieldCheck className="text-brand-gold" size={20} /> }
                ].map((item, i) => (
      ...
      <section className="py-24 bg-brand-cream relative overflow-hidden text-center border-t border-brand-muted/30" id="booking-section">
        ...
        <div className="max-w-4xl mx-auto px-6 relative z-10">
          <h2 className="text-3xl md:text-[56px] font-primary font-bold text-brand-dark leading-[1.1] mb-6 uppercase tracking-tighter text-black">
            Want to restore and enhance <br /> <span className="text-brand-gold italic font-normal text-4xl md:text-5xl lg:text-[52px]">your features naturally?</span>
          </h2>
          <p className="font-sans text-base md:text-lg text-brand-dark/60 mb-12 max-w-2xl mx-auto leading-relaxed">
            Book a free consultation — our dermatologist will assess your face and recommend exactly what is needed — nothing more, nothing less.
          </p>
