...
import { ArrowUpRight, Check, Phone, Target, Activity, ShieldCheck, HeartPulse } from 'lucide-react';
    ...
    <div className="bg-brand-cream min-h-screen pt-[104px]">
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        <nav className="text-[10px] md:text-xs uppercase tracking-[0.2em] font-bold text-brand-dark/40">
          ...
          <span className="mx-2 text-brand-gold">›</span>
          <span className="text-brand-dark uppercase tracking-widest">QR678 Hair Treatment</span>
        </nav>
      </div>
      ...
      <section className="max-w-7xl mx-auto px-6 pb-24">
        <div className="flex flex-col lg:flex-row gap-16 items-center">
          <div className="w-full lg:w-1/2">
            ...
            >
              QR678 — clinically proven <br /> <span className="text-brand-gold italic font-normal text-5xl md:text-[56px]">hair loss reversal</span>
            </motion.h1>
            <motion.p
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              QR678 is a patented, clinically proven proprietary formula developed by dermatologists specifically for hair loss treatment. Injected directly into the scalp, it works at the follicle level to reverse hair loss, restore density, and promote strong, healthy regrowth — with results backed by published clinical studies.
            </motion.p>
          ...
          <div className="w-full lg:w-1/2">
            <div className="aspect-[4/5] bg-[#E5E1DA] rounded-[24px] overflow-hidden relative border border-brand-muted/30 group">
              ...
              <div className="absolute inset-0 flex items-center justify-center text-brand-dark/10 uppercase tracking-widest text-[10px] font-bold">QR678 Treatment Image Placeholder</div>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="flex flex-col lg:flex-row gap-16">
            <div className="w-full lg:w-1/2 text-white">
              ...
              <h2 className="text-3xl md:text-5xl font-primary font-bold uppercase tracking-tighter leading-tight mb-8 text-white">
                Clinically proven. <br /> Not just promised.
              </h2>
              <p className="font-sans text-[16px] md:text-[18px] text-white/60 leading-[1.7] mb-8">
                QR678 is a prescription-only treatment that must be administered by a certified dermatologist. The injection technique, depth, and dosage must be precisely calibrated to your hair loss pattern and scalp condition. At Dermalife, every QR678 session is performed by our certified dermatologists who are trained in the official QR678 protocol.
              </p>
            ...
            <div className="w-full lg:w-1/2 flex items-center">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-6 w-full">
                {[
                  { text: "Clinically studied and proven formula", icon: <ShieldCheck className="text-brand-gold" size={20} /> },
                  { text: "Hair loss actively reversed", icon: <Activity className="text-brand-gold" size={20} /> },
                  { text: "Hair density visibly restored", icon: <Target className="text-brand-gold" size={20} /> },
                  { text: "Suitable for men and women", icon: <HeartPulse className="text-brand-gold" size={20} /> }
                ].map((item, i) => (
      ...
      <section className="py-24 bg-brand-cream relative overflow-hidden text-center border-t border-brand-muted/30" id="booking-section">
        ...
        <div className="max-w-4xl mx-auto px-6 relative z-10">
          <h2 className="text-3xl md:text-[56px] font-primary font-bold text-brand-dark leading-[1.1] mb-6 uppercase tracking-tighter text-black">
            Ready to reverse your hair loss <br /> <span className="text-brand-gold italic font-normal text-5xl md:text-[56px]">with a clinically proven treatment?</span>
          </h2>
          <p className="font-sans text-base md:text-lg text-brand-dark/60 mb-12 max-w-2xl mx-auto">
            Book a free consultation — our dermatologist will assess your scalp and tell you if QR678 is right for your hair loss pattern.
          </p>
