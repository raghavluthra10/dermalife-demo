...
import { ArrowUpRight, Check, Phone, Droplets, Activity, RefreshCw, Heart } from 'lucide-react';
    ...
    <div className="bg-brand-cream min-h-screen pt-[104px]">
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        <nav className="text-[10px] md:text-xs uppercase tracking-[0.2em] font-bold text-brand-dark/40">
          ...
          <span className="mx-2 text-brand-gold">›</span>
          <span className="text-brand-dark uppercase">Detox & Deep Tissue Massage</span>
        </nav>
      </div>
      ...
      <section className="max-w-7xl mx-auto px-6 pb-24">
        <div className="flex flex-col lg:flex-row gap-16 items-center">
          <div className="w-full lg:w-1/2">
            ...
            >
              Detox & deep tissue <br /> <span className="text-brand-gold italic font-normal text-5xl md:text-[56px]">drain, restore & refresh</span>
            </motion.h1>
            <motion.p
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              A therapeutic body treatment that combines lymphatic drainage and deep tissue massage techniques to flush out toxins, reduce water retention, ease muscle tension, and improve circulation throughout the body. The perfect complement to any slimming or body contouring program.
            </motion.p>
          ...
          <div className="w-full lg:w-1/2">
            <div className="aspect-[4/5] bg-[#E5E1DA] rounded-[24px] overflow-hidden relative border border-brand-muted/30">
              <div className="absolute inset-0 flex items-center justify-center text-brand-dark/10 uppercase tracking-widest text-[10px] font-bold">Detox Massage Image Placeholder</div>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="flex flex-col lg:flex-row gap-16">
            <div className="w-full lg:w-1/2 text-white">
              ...
              <h2 className="text-3xl md:text-5xl font-primary font-bold uppercase tracking-tighter leading-tight mb-8 text-white">
                Your body needs to detox <br /> as much as your skin does.
              </h2>
              <p className="font-sans text-[16px] md:text-[18px] text-white/60 leading-[1.7] mb-8">
                At Dermalife, our detox and deep tissue massage treatments are performed by trained therapists under clinical supervision — using professional techniques and therapeutic-grade products to maximise lymphatic drainage, reduce inflammation, and support your body's natural detoxification process.
              </p>
            ...
            <div className="w-full lg:w-1/2 flex items-center">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-6 w-full">
                {[
                  { text: "Toxins and water retention drained", icon: <Droplets className="text-brand-gold" size={20} /> },
                  { text: "Circulation and lymphatic flow improved", icon: <RefreshCw className="text-brand-gold" size={20} /> },
                  { text: "Muscle tension and soreness relieved", icon: <Activity className="text-brand-gold" size={20} /> },
                  { text: "Complements all slimming treatments", icon: <Heart className="text-brand-gold" size={20} /> }
                ].map((item, i) => (
      ...
      <section className="py-24 bg-brand-cream relative overflow-hidden text-center border-t border-brand-muted/30" id="booking-section">
        ...
        <div className="max-w-4xl mx-auto px-6 relative z-10">
          <h2 className="text-3xl md:text-[56px] font-primary font-bold text-brand-dark leading-[1.1] mb-6 uppercase tracking-tighter text-black">
            Ready to drain, detox <br /> <span className="text-brand-gold italic font-normal text-5xl md:text-[56px]">and restore your body?</span>
          </h2>
          <p className="font-sans text-base md:text-lg text-brand-dark/60 mb-12 max-w-2xl mx-auto">
            Book a free consultation — our team will assess your goals and recommend the right massage protocol for you.
          </p>
