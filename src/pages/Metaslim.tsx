...
import { ArrowUpRight, Check, Phone, Zap, TrendingUp, Sparkles, ShieldCheck } from 'lucide-react';
    ...
    <div className="bg-brand-cream min-h-screen pt-[104px]">
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        <nav className="text-[10px] md:text-xs uppercase tracking-[0.2em] font-bold text-brand-dark/40">
          ...
          <span className="mx-2 text-brand-gold">›</span>
          <span className="text-brand-dark uppercase tracking-widest">Metaslim & Trimbit</span>
        </nav>
      </div>
      ...
      <section className="max-w-7xl mx-auto px-6 pb-24">
        <div className="flex flex-col lg:flex-row gap-16 items-center">
          <div className="w-full lg:w-1/2">
            ...
            >
              Metaslim & Trimbit — <br /> <span className="text-brand-gold italic font-normal text-5xl md:text-[56px]">metabolic slimming</span>
            </motion.h1>
            <motion.p
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              Metaslim and Trimbit are advanced metabolic slimming treatments that target deep fat layers to deliver lasting inch loss and body reshaping. Working at a metabolic level, these treatments accelerate fat breakdown in stubborn areas that diet and exercise alone cannot reach — for visible, measurable results.
            </motion.p>
          ...
          <div className="w-full lg:w-1/2">
            <div className="aspect-[4/5] bg-[#E5E1DA] rounded-[24px] overflow-hidden relative border border-brand-muted/30 group">
              ...
              <div className="absolute inset-0 flex items-center justify-center text-brand-dark/10 uppercase tracking-widest text-[10px] font-bold">Metaslim & Trimbit Image Placeholder</div>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="flex flex-col lg:flex-row gap-16">
            <div className="w-full lg:w-1/2 text-white">
              ...
              <h2 className="text-3xl md:text-5xl font-primary font-bold uppercase tracking-tighter leading-tight mb-8 text-white">
                Target the fat that <br /> nothing else can reach.
              </h2>
              <p className="font-sans text-[16px] md:text-[18px] text-white/60 leading-[1.7] mb-8">
                Metaslim and Trimbit work at a metabolic level — targeting deep fat deposits that conventional treatments cannot reach. At Dermalife, every treatment is assessed and supervised by our certified dermatologists who calibrate the protocol to your specific fat distribution, metabolism, and body composition goals.
              </p>
            ...
            <div className="w-full lg:w-1/2 flex items-center">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-6 w-full">
                {[
                  { text: "Deep fat layers targeted metabolically", icon: <Zap className="text-brand-gold" size={20} /> },
                  { text: "Stubborn inch loss delivered", icon: <TrendingUp className="text-brand-gold" size={20} /> },
                  { text: "Body shape visibly transformed", icon: <Sparkles className="text-brand-gold" size={20} /> },
      ...
      <section className="py-24 bg-brand-cream relative overflow-hidden text-center border-t border-brand-muted/30" id="booking-section">
        ...
        <div className="max-w-4xl mx-auto px-6 relative z-10">
          <h2 className="text-3xl md:text-[56px] font-primary font-bold text-brand-dark leading-[1.1] mb-6 uppercase tracking-tighter text-black">
            Ready to target the stubborn <br /> <span className="text-brand-gold italic font-normal text-5xl md:text-[56px]">fat that won't budge?</span>
          </h2>
          <p className="font-sans text-base md:text-lg text-brand-dark/60 mb-12 max-w-2xl mx-auto">
            Book a free consultation — our dermatologist will assess your body composition and design the right Metaslim or Trimbit protocol for you.
          </p>
