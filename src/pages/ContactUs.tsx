      ...
      <section className="pb-24 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24">
            ...
            >
              {/* Form */}
              <div className="bg-brand-green p-10 md:p-12 rounded-[3rem] shadow-2xl relative overflow-hidden">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <button 
                    type="submit"
                    className="w-full bg-brand-gold text-white font-primary font-bold uppercase tracking-[0.2em] py-5 rounded-2xl hover:bg-white hover:text-brand-green transition-all shadow-xl flex items-center justify-center gap-3 active:scale-[0.98]"
                  >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
                <div className="bg-white p-8 rounded-3xl shadow-sm border border-brand-muted hover:shadow-md transition-shadow">
                  ...
                  <h4 className="font-primary font-bold text-brand-green uppercase tracking-tight mb-2">Phone</h4>
                  <p className="text-brand-dark/60 text-sm font-medium">+91-8882047047</p>
                </div>
                <div className="bg-white p-8 rounded-3xl shadow-sm border border-brand-muted hover:shadow-md transition-shadow">
                  <Mail className="text-brand-gold mb-4" size={24} />
                  <h4 className="font-primary font-bold text-brand-green uppercase tracking-tight mb-2">Email</h4>
                ...
                <div className="bg-white p-8 rounded-3xl shadow-sm border border-brand-muted hover:shadow-md transition-shadow sm:col-span-2">
                  ...
                  <h4 className="font-primary font-bold text-brand-green uppercase tracking-tight mb-2">Clinic Address</h4>
            ...
            >
              <div className="absolute top-8 left-8 z-10 bg-white/90 backdrop-blur-md p-6 rounded-2xl shadow-lg border border-brand-muted max-w-[240px]">
                <h4 className="font-primary font-bold text-brand-green uppercase tracking-tight mb-2">Visit Our Clinic</h4>
