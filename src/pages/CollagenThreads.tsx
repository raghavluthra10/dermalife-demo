    ...
    <div className="bg-brand-cream min-h-screen pt-[104px]">
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        <nav className="text-[10px] md:text-xs uppercase tracking-[0.2em] font-bold text-brand-dark/40">
          ...
          <span className="mx-2 text-brand-gold">›</span>
          <span className="text-brand-dark uppercase tracking-widest">Collagen Threads</span>
        </nav>
      </div>
      ...
      <section className="max-w-7xl mx-auto px-6 pb-24">
        <div className="flex flex-col lg:flex-row gap-16 items-center">
          <div className="w-full lg:w-1/2">
            ...
            >
              Collagen threads — <br /> <span className="text-brand-gold italic font-normal text-5xl md:text-[56px]">non-surgical face lift</span>
            </motion.h1>
            <motion.p
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              Collagen thread lifting is a minimally invasive treatment that uses dissolvable threads inserted under the skin to physically lift and tighten sagging facial tissue. As the threads dissolve over time, they stimulate the body's own collagen production — delivering a lifting effect that continues to improve for months after treatment.
            </motion.p>
          ...
          <div className="w-full lg:w-1/2">
            <div className="aspect-[4/5] bg-[#E5E1DA] rounded-[24px] overflow-hidden relative border border-brand-muted/30 group">
              ...
              <div className="absolute inset-0 flex items-center justify-center text-brand-dark/10 uppercase tracking-widest text-[10px] font-bold">Threads Image Placeholder</div>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="flex flex-col lg:flex-row gap-16">
            <div className="w-full lg:w-1/2 text-white">
              ...
              <h2 className="text-3xl md:text-5xl font-primary font-bold uppercase tracking-tighter leading-tight mb-8 text-white">
                The lift of a facelift. <br /> Without the surgery.
              </h2>
              <p className="font-sans text-[16px] md:text-[18px] text-white/60 leading-[1.7] mb-8">
                Thread lifting requires a thorough understanding of facial anatomy and precise insertion technique to achieve a natural, symmetrical lift without complications. At Dermalife, every thread lift is performed exclusively by our certified dermatologists who are trained in advanced thread placement techniques for safe, natural, long-lasting results.
              </p>
            ...
            <div className="w-full lg:w-1/2 flex items-center">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-6 w-full">
                {[
                  { text: "Sagging skin physically lifted", icon: <Target className="text-brand-gold" size={20} /> },
                  { text: "Collagen production stimulated", icon: <Zap className="text-brand-gold" size={20} /> },
                  { text: "Results improve over 3–6 months", icon: <Activity className="text-brand-gold" size={20} /> },
                  { text: "Minimally invasive, minimal downtime", icon: <ShieldCheck className="text-brand-gold" size={20} /> }
                ].map((item, i) => (
      ...
      <section className="py-24 bg-brand-cream relative overflow-hidden text-center border-t border-brand-muted/30" id="booking-section">
        ...
        <div className="max-w-4xl mx-auto px-6 relative z-10">
          <h2 className="text-3xl md:text-[56px] font-primary font-bold text-brand-dark leading-[1.1] mb-6 uppercase tracking-tighter text-black">
            Want a natural lift <br /> <span className="text-brand-gold italic font-normal text-4xl md:text-5xl lg:text-[52px]">without surgery?</span>
          </h2>
          <p className="font-sans text-base md:text-lg text-brand-dark/60 mb-12 max-w-2xl mx-auto leading-relaxed">
            Book a free consultation — our dermatologist will assess your face and tell you if collagen thread lifting is the right treatment for your concern.
          </p>
...
export default CollagenThreads;
