    ...
    <div className="bg-brand-cream min-h-screen pt-[104px]">
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        <nav className="text-[10px] md:text-xs uppercase tracking-[0.2em] font-bold text-brand-dark/40">
          ...
          <span className="mx-2 text-brand-gold">›</span>
          <span className="text-brand-dark uppercase tracking-widest">Detox Facial</span>
        </nav>
      </div>
        ...
        <div className="flex flex-col lg:flex-row gap-16 items-center">
          <div className="w-full lg:w-1/2">
            ...
            >
              ...
              Detox facial — <br /> <span className="text-brand-gold italic font-normal text-5xl md:text-[56px]">deep cleanse & purification</span>
            </motion.h1>
            <motion.p
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              A deep cleansing and detoxifying facial designed to draw out impurities, unclog congested pores, eliminate toxin buildup, and restore skin clarity. The perfect reset for skin that feels congested, dull, and overwhelmed — delivering a deep clean that no at-home routine can replicate.
            </motion.p>
          ...
          <div className="w-full lg:w-1/2">
            <div className="aspect-[4/5] bg-[#E5E1DA] rounded-[24px] overflow-hidden relative border border-brand-muted/30 group">
              ...
              <div className="absolute inset-0 flex items-center justify-center text-brand-dark/10 uppercase tracking-widest text-[10px] font-bold">Detox Facial Image Placeholder</div>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="flex flex-col lg:flex-row gap-16">
            <div className="w-full lg:w-1/2 text-white">
              ...
              <h2 className="text-3xl md:text-5xl font-primary font-bold uppercase tracking-tighter leading-tight mb-8 text-white">
                The deepest clean <br /> your skin has ever had.
              </h2>
              <p className="font-sans text-[16px] md:text-[18px] text-white/60 leading-[1.7] mb-8">
                Daily pollution, makeup, sunscreen, and sebum build up in the pores at a level that no home cleanser can reach. At Dermalife, our detox facial uses professional extraction techniques and clinical-grade purifying formulations to reach deep into the pores — removing congestion, toxins, and buildup that accumulates over weeks and months of daily life.
              </p>
            ...
            <div className="w-full lg:w-1/2 flex items-center">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-6 w-full">
                {[
                  { text: "Deep pore congestion cleared", icon: <Target className="text-brand-gold" size={20} /> },
                  { text: "Blackheads and whiteheads extracted", icon: <Activity className="text-brand-gold" size={20} /> },
                  { text: "Skin clarity and freshness restored", icon: <ShieldCheck className="text-brand-gold" size={20} /> },
                  { text: "Oiliness and congestion controlled", icon: <Zap className="text-brand-gold" size={20} /> }
                ].map((item, i) => (
      ...
      <section className="py-24 bg-brand-cream relative overflow-hidden text-center border-t border-brand-muted/30" id="booking-section">
        ...
        <div className="max-w-4xl mx-auto px-6 relative z-10">
          <h2 className="text-3xl md:text-[56px] font-primary font-bold text-brand-dark leading-[1.1] mb-6 uppercase tracking-tighter text-black">
            Ready to give your skin <br /> <span className="text-brand-gold italic font-normal text-4xl md:text-5xl lg:text-[52px]">the deepest clean it has ever had?</span>
          </h2>
          <p className="font-sans text-base md:text-lg text-brand-dark/60 mb-12 max-w-2xl mx-auto leading-relaxed">
            Book a free consultation — our specialists will assess your skin and recommend the right detox protocol for you.
          </p>
