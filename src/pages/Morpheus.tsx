    ...
    <div className="bg-brand-cream min-h-screen pt-[104px]">
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        <nav className="text-[10px] md:text-xs uppercase tracking-[0.2em] font-bold text-brand-dark/40">
          ...
          <span className="mx-2 text-brand-gold">›</span>
          <span className="text-brand-dark uppercase tracking-widest">Morpheus</span>
        </nav>
      </div>
      ...
      <section className="max-w-7xl mx-auto px-6 pb-24">
        <div className="flex flex-col lg:flex-row gap-16 items-center">
          <div className="w-full lg:w-1/2">
            ...
            >
              Morpheus — deep skin <br /> <span className="text-brand-gold italic font-normal text-5xl md:text-[56px]">remodelling & tightening</span>
            </motion.h1>
            <motion.p 
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              Fractional radiofrequency microneedling that remodels and contours the face by stimulating collagen production in the deepest layers of the skin. Combines the precision of microneedling with the power of radiofrequency energy — delivering results previously only achievable through surgery.
            </motion.p>
          ...
          <div className="w-full lg:w-1/2">
            <div className="aspect-[4/5] bg-[#E5E1DA] rounded-[24px] overflow-hidden relative border border-brand-muted/30">
              <div className="absolute inset-0 flex items-center justify-center text-brand-dark/10 uppercase tracking-widest text-[10px] font-bold">Morpheus Image Placeholder</div>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="flex flex-col lg:flex-row gap-16">
            <div className="w-full lg:w-1/2 text-white">
              ...
              <h2 className="text-3xl md:text-5xl font-primary font-bold uppercase tracking-tighter leading-tight mb-8 text-white">
                Deeper results. <br /> Without surgery.
              </h2>
              <p className="font-sans text-[16px] md:text-[18px] text-white/60 leading-[1.7] mb-8">
                Morpheus depth and energy settings must be precisely calibrated to each patient's anatomy and skin concern. At Dermalife, every Morpheus treatment is planned and performed by our certified dermatologists — ensuring the radiofrequency energy reaches exactly the right tissue depth for your concern.
              </p>
            ...
            <div className="w-full lg:w-1/2 flex items-center">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-6 w-full">
                {[
                  { text: "Acne scars and skin texture remodelled", icon: <Layers className="text-brand-gold" size={20} /> },
                  { text: "Jawline and face contour defined", icon: <Target className="text-brand-gold" size={20} /> },
                  { text: "Results last 1–2 years", icon: <Sparkles className="text-brand-gold" size={20} /> },
                  { text: "Suitable for face and body", icon: <Zap className="text-brand-gold" size={20} /> }
                ].map((item, i) => (
      ...
      <section className="py-24 bg-brand-cream relative overflow-hidden text-center border-t border-brand-muted/30">
        ...
        <div className="max-w-4xl mx-auto px-6 relative z-10">
          <h2 className="text-3xl md:text-[56px] font-primary font-bold text-brand-dark leading-[1.1] mb-6 uppercase tracking-tighter text-black">
            Ready for visibly <br /> <span className="text-brand-gold italic font-normal">tighter, smoother skin?</span>
          </h2>
          <p className="font-sans text-base md:text-lg text-brand-dark/60 mb-12 max-w-2xl mx-auto">
            Book a free consultation — our dermatologist will assess your skin and tell you if Morpheus is right for you.
          </p>
