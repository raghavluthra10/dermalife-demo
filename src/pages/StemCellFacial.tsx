    ...
    <div className="bg-brand-cream min-h-screen pt-[104px]">
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        <nav className="text-[10px] md:text-xs uppercase tracking-[0.2em] font-bold text-brand-dark/40">
          ...
          <span className="mx-2 text-brand-gold">›</span>
          <span className="text-brand-dark uppercase tracking-widest">Stem Cell Anti-Ageing Facial</span>
        </nav>
      </div>
      ...
      <section className="max-w-7xl mx-auto px-6 pb-24">
        <div className="flex flex-col lg:flex-row gap-16 items-center">
          <div className="w-full lg:w-1/2">
            ...
            >
              Stem cell anti-ageing <br /> <span className="text-brand-gold italic font-normal text-5xl md:text-[56px]">facial — reverse ageing</span>
            </motion.h1>
            <motion.p
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              An advanced anti-ageing facial that harnesses the regenerative power of stem cell technology to reverse visible signs of ageing. Using stem cell-derived growth factors and actives, this facial stimulates deep cellular renewal — firming, lifting, and restoring youthful radiance to ageing skin.
            </motion.p>
          ...
          <div className="w-full lg:w-1/2">
            <div className="aspect-[4/5] bg-[#E5E1DA] rounded-[24px] overflow-hidden relative border border-brand-muted/30 group">
              ...
              <div className="absolute inset-0 flex items-center justify-center text-brand-dark/10 uppercase tracking-widest text-[10px] font-bold">Stem Cell Facial Image Placeholder</div>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="flex flex-col lg:flex-row gap-16">
            <div className="w-full lg:w-1/2 text-white">
              ...
              <h2 className="text-3xl md:text-5xl font-primary font-bold uppercase tracking-tighter leading-tight mb-8 text-white">
                Anti-ageing at <br /> a cellular level.
              </h2>
              <p className="font-sans text-[16px] md:text-[18px] text-white/60 leading-[1.7] mb-8">
                Most anti-ageing facials work only on the surface — moisturising and temporarily plumping without addressing the underlying cause of skin ageing. At Dermalife, our Stem Cell Anti-Ageing Facial uses pharmaceutical-grade stem cell actives that communicate with skin cells at a biological level — triggering real collagen synthesis, cellular repair, and deep skin renewal.
              </p>
            ...
            <div className="w-full lg:w-1/2 flex items-center">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-6 w-full">
                {[
                  { text: "Collagen synthesis stimulated deeply", icon: <Target className="text-brand-gold" size={20} /> },
                  { text: "Fine lines and wrinkles visibly reduced", icon: <Zap className="text-brand-gold" size={20} /> },
                  { text: "Skin firmness and elasticity restored", icon: <ShieldCheck className="text-brand-gold" size={20} /> },
                  { text: "Youthful radiance and glow renewed", icon: <Activity className="text-brand-gold" size={20} /> }
                ].map((item, i) => (
      ...
      <section className="py-24 bg-brand-cream relative overflow-hidden text-center border-t border-brand-muted/30" id="booking-section">
        ...
        <div className="max-w-4xl mx-auto px-6 relative z-10">
          <h2 className="text-3xl md:text-[56px] font-primary font-bold text-brand-dark leading-[1.1] mb-6 uppercase tracking-tighter text-black">
            Want to reverse your skin's <br /> <span className="text-brand-gold italic font-normal text-4xl md:text-5xl lg:text-[52px]">visible signs of ageing?</span>
          </h2>
          <p className="font-sans text-base md:text-lg text-brand-dark/60 mb-12 max-w-2xl mx-auto leading-relaxed">
            Book a free consultation — our specialists will assess your skin age and recommend the right anti-ageing facial protocol for you.
          </p>
