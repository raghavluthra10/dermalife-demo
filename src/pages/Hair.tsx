...
const Hair = () => {
  ...
  const concerns = [
    { text: "Hair fall and excessive shedding", icon: <Activity size={16} /> },
    { text: "Thinning hair and loss of density", icon: <Layers size={16} /> },
    { text: "Receding hairline", icon: <Target size={16} /> },
    { text: "Bald patches and alopecia", icon: <ShieldCheck size={16} /> },
    { text: "Scalp inflammation and dandruff", icon: <Sparkles size={16} /> },
    { text: "Weak and brittle hair", icon: <HeartPulse size={16} /> },
    { text: "Male pattern baldness", icon: <Zap size={16} /> },
    { text: "Female pattern hair loss", icon: <Clock size={16} /> },
    { text: "Post-pregnancy hair loss", icon: <Activity size={16} /> },
    { text: "Stress-related hair fall", icon: <Activity size={16} /> },
    { text: "Scalp dryness and irritation", icon: <Sparkles size={16} /> },
    { text: "Slow hair growth", icon: <RefreshCw size={16} /> },
  ];
    ...
    <div className="bg-brand-cream min-h-screen pt-[104px]">
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        <nav className="text-[10px] md:text-xs uppercase tracking-[0.2em] font-bold text-brand-dark/40">
          ...
          <span className="text-brand-dark">Hair</span>
        </nav>
      </div>
      ...
      <section className="max-w-7xl mx-auto px-6 pb-24">
        <div className="flex flex-col min-[929px]:flex-row gap-12 lg:gap-24 items-start">
          ...
          <div className="w-full min-[929px]:w-[60%] flex flex-col pt-4">
            ...
            >
              Whether you're dealing with hair fall, thinning, receding hairline, or scalp concerns — every hair treatment at Dermalife begins with a detailed scalp and hair analysis by our certified dermatologist. We identify the root cause first, then build a treatment plan specific to your hair type, concern, and goals. No guesswork. No generic protocols.
            </motion.p>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-brand-dark/50 text-sm md:text-base max-w-xl mx-auto">
              Every hair treatment at Dermalife is performed under dermatologist supervision. We identify the root cause of your hair concern before recommending any treatment.
            </p>
          </div>
      ...
      <section className="py-24 bg-white border-t border-brand-muted/20">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="flex overflow-x-auto no-scrollbar snap-x snap-mandatory lg:grid lg:grid-cols-3 gap-8 pb-4 lg:pb-0">
            {/* Corrected animation and layout to prevent "wobble" */}
            {[
              { title: "Hair Density Restoration", patient: "Amit S.", treatment: "QR 678 + PRP" },
              { title: "Receding Hairline Filling", patient: "Vikram R.", treatment: "GFC + Mesotherapy" },
              { title: "Alopecia Recovery", patient: "Neha P.", treatment: "Exosome Therapy" },
            ].map((result, i) => (
              <motion.div 
                key={i}
              ...
              >
                ...
                <div className="p-8">
                  ...
                  <p className="text-brand-dark/60 text-sm font-sans mb-6 leading-relaxed">
                    "I was skeptical about non-surgical hair restoration, but the results speak for themselves. My density is back and my confidence is higher than ever."
                  </p>
