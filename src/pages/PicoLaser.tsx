    ...
    <div className="bg-brand-cream min-h-screen pt-[104px]">
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        <nav className="text-[10px] md:text-xs uppercase tracking-[0.2em] font-bold text-brand-dark/40">
          ...
          <span className="mx-2 text-brand-gold">›</span>
          <span className="text-brand-dark">Pico Laser</span>
        </nav>
      </div>
      ...
      <section className="max-w-7xl mx-auto px-6 pb-24">
        <div className="flex flex-col lg:flex-row gap-16 items-center">
          <div className="w-full lg:w-1/2">
            ...
            >
              Pico laser — advanced <br /> <span className="text-brand-gold italic font-normal text-5xl md:text-[56px]">pigmentation & toning</span>
            </motion.h1>
            <motion.p
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              One of the most advanced laser technologies available for skin brightening and pigmentation correction. Pico laser delivers ultra-short bursts of energy in picoseconds — shattering pigment particles and stimulating collagen without damaging surrounding skin. Safe and effective for Indian skin tones.
            </motion.p>
          ...
          <div className="flex flex-col lg:flex-row gap-16">
            <div className="w-full lg:w-1/2 text-white">
              ...
              <p className="font-sans text-[16px] md:text-[18px] text-white/60 leading-[1.7] mb-8">
                Pico laser on Indian skin requires precise calibration to avoid triggering post-inflammatory hyperpigmentation. Our dermatologists customise every session — wavelength, energy, and pulse duration — based on your specific skin tone, concern, and response to previous treatments.
              </p>
            ...
            <div className="w-full lg:w-1/2 flex items-center">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-6 w-full">
                {[
                  ...
                  { text: "Skin tone brightened and evened", icon: <Sparkles className="text-brand-gold" size={20} /> },
                  { text: "Acne scars and marks faded", icon: <Check className="text-brand-gold" size={20} /> },
                  { text: "Safe for all Indian skin tones", icon: <ShieldCheck className="text-brand-gold" size={20} /> }
                ].map((item, i) => (
      ...
      <section className="py-24 bg-brand-cream relative overflow-hidden text-center border-t border-brand-muted/30">
        ...
        <div className="max-w-4xl mx-auto px-6 relative z-10">
          <h2 className="text-3xl md:text-[56px] font-primary font-bold text-brand-dark leading-[1.1] mb-6 uppercase tracking-tighter text-black">
            Ready for clearer, <br /> <span className="text-brand-gold italic font-normal">more even skin?</span>
          </h2>
          <p className="font-sans text-base md:text-lg text-brand-dark/60 mb-12 max-w-2xl mx-auto">
            Book a free consultation — our dermatologist will assess your pigmentation and recommend the right laser protocol.
          </p>
