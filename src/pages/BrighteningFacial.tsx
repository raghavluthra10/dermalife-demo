...
import { ArrowUpRight, Check, Phone, Sparkles, Target, Layers, ShieldCheck, Zap } from 'lucide-react';
    ...
    <div className="bg-brand-cream min-h-screen pt-[104px]">
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        <nav className="text-[10px] md:text-xs uppercase tracking-[0.2em] font-bold text-brand-dark/40">
          ...
          <span className="mx-2 text-brand-gold">›</span>
          <span className="text-brand-dark uppercase tracking-widest">Brightening Facial</span>
        </nav>
      </div>
      ...
      <section className="max-w-7xl mx-auto px-6 pb-24">
        <div className="flex flex-col lg:flex-row gap-16 items-center">
          <div className="w-full lg:w-1/2">
            ...
            >
              Dermal skin brightening <br /> <span className="text-brand-gold italic font-normal text-5xl md:text-[56px]">facial — instant glow</span>
            </motion.h1>
            <motion.p
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              A professional brightening facial that targets dullness, uneven skin tone, and pigmentation using clinical-grade brightening actives and techniques. Delivers an immediate, visible glow from the very first session — with cumulative brightening results that improve with every treatment.
            </motion.p>
          ...
          <div className="w-full lg:w-1/2">
            <div className="aspect-[4/5] bg-[#E5E1DA] rounded-[24px] overflow-hidden relative border border-brand-muted/30 group">
              ...
              <div className="absolute inset-0 flex items-center justify-center text-brand-dark/10 uppercase tracking-widest text-[10px] font-bold">Brightening Facial Placeholder</div>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="flex flex-col lg:flex-row gap-16">
            <div className="w-full lg:w-1/2 text-white">
              ...
              <h2 className="text-3xl md:text-5xl font-primary font-bold uppercase tracking-tighter leading-tight mb-8 text-white">
                Not a glow. <br /> A transformation.
              </h2>
              <p className="font-sans text-[16px] md:text-[18px] text-white/60 leading-[1.7] mb-8">
                Most brightening facials use generic formulations that produce a temporary surface glow that fades within days. At Dermalife, our dermal brightening facial uses professional-grade brightening actives and clinical application techniques that penetrate deeper into the skin — delivering results that actually last and improve with every session.
              </p>
            ...
            <div className="w-full lg:w-1/2 flex items-center">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-6 w-full">
                {[
                  { text: "Dullness and uneven tone corrected", icon: <Target className="text-brand-gold" size={20} /> },
                  { text: "Pigmentation and dark spots faded", icon: <Layers className="text-brand-gold" size={20} /> },
                  { text: "Immediate visible glow from session one", icon: <Sparkles className="text-brand-gold" size={20} /> },
                  { text: "Cumulative brightening with every session", icon: <Zap className="text-brand-gold" size={20} /> }
                ].map((item, i) => (
      ...
      <section className="py-24 bg-brand-cream relative overflow-hidden text-center border-t border-brand-muted/30" id="booking-section">
        ...
        <div className="max-w-4xl mx-auto px-6 relative z-10">
          <h2 className="text-3xl md:text-[56px] font-primary font-bold text-brand-dark leading-[1.1] mb-6 uppercase tracking-tighter text-black">
            Want instantly brighter, <br /> <span className="text-brand-gold italic font-normal text-4xl md:text-5xl lg:text-[52px]">more radiant skin?</span>
          </h2>
          <p className="font-sans text-base md:text-lg text-brand-dark/60 mb-12 max-w-2xl mx-auto leading-relaxed">
            Book a free consultation — our specialists will assess your skin tone and recommend the right brightening protocol for you.
          </p>
...
export default BrighteningFacial;
