...
import { ArrowUpRight, Check, Phone, Target, Sparkles, Activity, Clock, ShieldCheck } from 'lucide-react';
    ...
    <div className="bg-brand-cream min-h-screen pt-[104px]">
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        <nav className="text-[10px] md:text-xs uppercase tracking-[0.2em] font-bold text-brand-dark/40">
          ...
          <span className="mx-2 text-brand-gold">›</span>
          <span className="text-brand-dark">Ondacool</span>
        </nav>
      </div>
      ...
      <section className="max-w-7xl mx-auto px-6 pb-24">
        <div className="flex flex-col lg:flex-row gap-16 items-center">
          <div className="w-full lg:w-1/2">
            ...
            >
              Ondacool uses targeted cool energy combined with microwave technology to simultaneously reduce stubborn fat and tighten skin — without surgery, needles, or downtime. Available for both face and body, it delivers visible inch loss and contouring with zero recovery time.
            </motion.p>
          ...
          <div className="flex flex-col lg:flex-row gap-16">
            <div className="w-full lg:w-1/2 text-white">
              ...
              <p className="font-sans text-[16px] md:text-[18px] text-white/60 leading-[1.7] mb-8">
                Ondacool targets both the fat layer and the skin simultaneously — most fat reduction treatments do one or the other. At Dermalife, every Ondacool treatment is assessed and supervised by our certified dermatologists who calibrate the energy settings to your specific body composition and target areas.
              </p>
      ...
      <section className="py-24 bg-brand-cream relative overflow-hidden text-center border-t border-brand-muted/30">
        ...
        <div className="max-w-4xl mx-auto px-6 relative z-10">
          ...
          <p className="font-sans text-base md:text-lg text-brand-dark/60 mb-12 max-w-2xl mx-auto">
            Book a free consultation — our dermatologist will assess your target areas and design the right Ondacool protocol for you.
          </p>
