    ...
    <div className="bg-brand-cream min-h-screen pt-[104px]">
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        <nav className="text-[10px] md:text-xs uppercase tracking-[0.2em] font-bold text-brand-dark/40">
          ...
          <span className="mx-2 text-brand-gold">›</span>
          <span className="text-brand-dark">HIFU</span>
        </nav>
      </div>
      ...
      <section className="max-w-7xl mx-auto px-6 pb-24">
        <div className="flex flex-col lg:flex-row gap-16 items-center">
          <div className="w-full lg:w-1/2">
            ...
            >
              HIFU: non-surgical <br /> <span className="text-brand-gold italic font-normal text-5xl md:text-[56px]">skin tightening</span>
            </motion.h1>
            <motion.p
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              The gold standard in non-surgical lifting. HIFU uses focused ultrasound energy to stimulate deep collagen production — lifting and firming the skin with zero incisions and zero downtime.
            </motion.p>
          ...
          <div className="flex flex-col lg:flex-row gap-16">
            <div className="w-full lg:w-1/2 text-white">
              ...
              <p className="font-sans text-[16px] md:text-[18px] text-white/60 leading-[1.7] mb-8">
                HIFU results depend entirely on the precision of delivery and device calibration. At Dermalife, every HIFU treatment is performed by certified dermatologists using FDA-approved devices — ensuring energy reaches exactly the right depth for your skin concern.
              </p>
            ...
            <div className="w-full lg:w-1/2 flex items-center">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-6 w-full">
                {[
                  ...
                  { text: "Results last 12–18 months", icon: <Clock className="text-brand-gold" size={20} /> },
                  { text: "Jawline redefined", icon: <Layers className="text-brand-gold" size={20} /> },
                  { text: "Zero downtime, back to life immediately", icon: <ShieldCheck className="text-brand-gold" size={20} /> }
                ].map((item, i) => (
      ...
      <section className="py-24 bg-brand-cream relative overflow-hidden text-center border-t border-brand-muted/30">
        ...
        <div className="max-w-4xl mx-auto px-6 relative z-10">
          <h2 className="text-3xl md:text-[56px] font-primary font-bold text-brand-dark leading-[1.1] mb-12 uppercase tracking-tighter text-black">
            Want firmer, lifted skin <br /> <span className="text-brand-gold italic font-normal">without surgery?</span>
          </h2>
