    ...
    <div className="bg-brand-cream min-h-screen pt-[104px]">
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        <nav className="text-[10px] md:text-xs uppercase tracking-[0.2em] font-bold text-brand-dark/40">
          ...
          <span className="mx-2 text-brand-gold">›</span>
          <span className="text-brand-dark uppercase tracking-widest">PRP Hair Treatment</span>
        </nav>
      </div>
      ...
      <section className="max-w-7xl mx-auto px-6 pb-24">
        <div className="flex flex-col lg:flex-row gap-16 items-center">
          <div className="w-full lg:w-1/2">
            ...
            >
              PRP hair treatment — <br /> <span className="text-brand-gold italic font-normal text-5xl md:text-[56px]">reactivate follicles naturally</span>
            </motion.h1>
            <motion.p
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              Platelet-Rich Plasma therapy uses the growth factors in your own blood to reactivate dormant hair follicles and stimulate natural hair regrowth. A proven, clinically administered treatment for hair fall, thinning, and early-stage hair loss — with no surgery and no downtime.
            </motion.p>
          ...
          <div className="w-full lg:w-1/2">
            <div className="aspect-[4/5] bg-[#E5E1DA] rounded-[24px] overflow-hidden relative border border-brand-muted/30 group">
              ...
              <div className="absolute inset-0 flex items-center justify-center text-brand-dark/10 uppercase tracking-widest text-[10px] font-bold">PRP Treatment Image Placeholder</div>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="flex flex-col lg:flex-row gap-16">
            <div className="w-full lg:w-1/2 text-white">
              ...
              <h2 className="text-3xl md:text-5xl font-primary font-bold uppercase tracking-tighter leading-tight mb-8 text-white">
                Your own body's growth factors. <br /> Working for your hair.
              </h2>
              <p className="font-sans text-[16px] md:text-[18px] text-white/60 leading-[1.7] mb-8">
                PRP results depend entirely on the concentration of platelets and the precision of injection technique. At Dermalife, every PRP session is performed by our certified dermatologists using calibrated centrifuge protocols — ensuring maximum platelet concentration and correct depth of scalp injection for your specific hair loss pattern.
              </p>
            ...
            <div className="w-full lg:w-1/2 flex items-center">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-6 w-full">
                {[
                  { text: "Hair fall reduced from first few sessions", icon: <Activity className="text-brand-gold" size={20} /> },
                  { text: "Dormant follicles reactivated", icon: <Zap className="text-brand-gold" size={20} /> },
                  { text: "Hair density and thickness improved", icon: <Target className="text-brand-gold" size={20} /> },
                  { text: "100% natural — uses your own plasma", icon: <HeartPulse className="text-brand-gold" size={20} /> }
                ].map((item, i) => (
      ...
      <section className="py-24 bg-brand-cream relative overflow-hidden text-center border-t border-brand-muted/30" id="booking-section">
        ...
        <div className="max-w-4xl mx-auto px-6 relative z-10">
          <h2 className="text-3xl md:text-[56px] font-primary font-bold text-brand-dark leading-[1.1] mb-6 uppercase tracking-tighter text-black">
            Ready to stop the fall <br /> <span className="text-brand-gold italic font-normal text-5xl md:text-[56px]">and restart the growth?</span>
          </h2>
          <p className="font-sans text-base md:text-lg text-brand-dark/60 mb-12 max-w-2xl mx-auto">
            Book a free consultation — our dermatologist will analyse your scalp and tell you if PRP is right for your hair concern.
          </p>
